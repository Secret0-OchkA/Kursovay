...
namespace Context.Migrations
{
    ...
    [Migration("20221012105746_addCreateModifyDate")]
    partial class addCreateModifyDate
    {
            ...
            modelBuilder.Entity("Domain.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Name = "user",
                            createDate = new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1028), new TimeSpan(0, 3, 0, 0, 0)),
                            modifyDate = new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1029), new TimeSpan(0, 3, 0, 0, 0))
                        },
                        new
                        {
                            Id = 1,
                            Name = "owner",
                            createDate = new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1000), new TimeSpan(0, 3, 0, 0, 0)),
                            modifyDate = new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1023), new TimeSpan(0, 3, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Name = "accountant",
                            createDate = new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1026), new TimeSpan(0, 3, 0, 0, 0)),
                            modifyDate = new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1027), new TimeSpan(0, 3, 0, 0, 0))
                        });
                });
