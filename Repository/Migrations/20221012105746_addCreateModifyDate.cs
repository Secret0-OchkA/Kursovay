...
{
    public partial class addCreateModifyDate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "owner", new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1000), new TimeSpan(0, 3, 0, 0, 0)), new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1023), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 2, "accountant", new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1026), new TimeSpan(0, 3, 0, 0, 0)), new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1027), new TimeSpan(0, 3, 0, 0, 0)) },
                    { 3, "user", new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1028), new TimeSpan(0, 3, 0, 0, 0)), new DateTimeOffset(new DateTime(2022, 10, 12, 13, 57, 46, 353, DateTimeKind.Unspecified).AddTicks(1029), new TimeSpan(0, 3, 0, 0, 0)) }
                });
